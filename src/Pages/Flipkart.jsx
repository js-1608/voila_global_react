...
const items = [
  ...
  },
  {
    ...
    desc: " Assistance with all necessary seller documents and submission to Flipkart for verification.obtain offical brand approval so product can be listed under your brand name",
  },
  {
      ...
      <section className="bg-slate-50 py-16">
        ...
        <div className="w-full bg-linear-to-r from-violet-700 to-purple-800 py-3 mt-12">
          <p className="text-white text-center px-4 text-base sm:text-lg leading-relaxed font-medium">
            <span className="font-extrabold">Avail Walmart Certification</span>{" "}
            at no cost and unlock this exclusive
            <span className="font-extrabold"> FREE onboarding service.</span>
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4 lg:px-0 grid gap-10 lg:grid-cols-2 items-center">
          ...
          <div>
            ...
            <p className="mt-3 text-sm sm:text-base text-slate-50 max-w-xl leading-relaxed">
              ...
              mentoring, connect with market access and
              <span className="text-yellow-500"> Flipkart</span> onboarding
      ...
      <section className="bg-slate-50 py-16">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              Why <span className="text-violet-700">Work</span> With Us
            </p>

            <h2 className="text-amber-300 text-3xl sm:text-4xl font-extrabold uppercase tracking-wide animate-heartbeat">
              Efficiency, Expertise & End-to-End Management
            </h2>



            <p className="mt-3 text-sm sm:text-base text-slate-600 leading-relaxed">
              Our team brings together experience, process and data so your
              Flipkart account runs like a well-oiled growth machine instead of
              daily guesswork.
            </p>
          </div>
      ...
      >
        ...
        <div className="relative max-w-6xl mx-auto px-4 lg:px-0">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 mb-6 -mt-4">
            ...
            <span className="text-violet-700">Flipkart</span>
          </h2>
          <p className="max-w-xl text-sm sm:text-base text-slate-600 leading-relaxed mb-6">
            Flipkart offers reach, tools and insights to grow your brand. These
            tiles show the key advantages you unlock when you sell with a clear
            strategy.
          </p>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <p className="text-white">
                    Phone : <br />
                    <a href="tel:+919810554548" class="text-white">
                      +91 9810554548
                    </a>
                    <br />
                    <a href="tel:+919821554548" class="text-white">
                      +91 9821554548
                    </a>
                    <br />
                    <a href="tel:+919821654548" class="text-white">
                      +91 9821654548
                    </a>
                  </p>
                </div>
                ...
                <div>
                  <p className="text-white">
                    Email :
                    <a href="mailto:info@voilabiz.com" class="text-white">
                      info@voilabiz.com
                    </a>{" "}
                    <br />
                    <a href="mailto:info@intemim.com" class="text-white">
                      info@intemim.com
                    </a>
                  </p>
                </div>
